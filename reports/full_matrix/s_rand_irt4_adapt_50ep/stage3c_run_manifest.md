...
- 配置：`configs/s_rand_irt4_adapt.yaml`
- run dir：`reports/full_matrix/s_rand_irt4_adapt_50ep`
...
- rerun 最大差异：`0.0`
- 图像数量：`8`，非空：`True`
- checkpoint sha256：`9b769a5fd14b23cdf27baaf57af64114e3d4a512acd580c1335c1d4382ebc0e0`
